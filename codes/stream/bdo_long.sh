...
export T_AFF_NUM_TASK_MULTIPLICATOR=1
#export STREAM_ARRAY_SIZE=45000000000
export STREAM_ARRAY_SIZE=$((2**33))
...
# for i in 008 0016 032 048 064 080 104 128 144; do
# export OMP_NUM_THREADS=$i
# eval_run "domain.lowest" $first$none 1 "first_size_T$i"
# eval_run "domain.lowest" $divn$none 128 "divN_none_T$i"
# eval_run "domain.lowest" $step$none 32 "step_none_T$i"
# done
