...
#endif
#ifndef T_AFF_SINGLE_CREATOR
    #define T_AFF_SINGLE_CREATOR 1
#endif
...
//#   define STREAM_ARRAY_SIZE	120000000
#endif
...
main()
    ...
    b = alloc(STREAM_ARRAY_SIZE * sizeof(STREAM_TYPE));
    c = alloc(STREAM_ARRAY_SIZE * sizeof(STREAM_TYPE));
#endif
