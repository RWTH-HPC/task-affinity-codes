...
#define BOTS_APP_DEF_ARG_CUTOFF 16
...
#define BOTS_APP_INIT\
    ...
    init_matrix(bots_arg_size,A,bots_arg_size, 1);\
    init_matrix(bots_arg_size,B,bots_arg_size, 2);\
    init_matrix(bots_arg_size,C,bots_arg_size, 3);\
    init_matrix(bots_arg_size,D,bots_arg_size, 4);\
