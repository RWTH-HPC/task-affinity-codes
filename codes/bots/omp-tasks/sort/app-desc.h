...
#define BOTS_APP_PARAMETERS_DESC "N=%ld:Q=%d:I=%d:M=%d"
...
//#define BOTS_APP_DEF_ARG_CUTOFF_1 (2*1024*2)
//#define BOTS_APP_DEF_ARG_CUTOFF_1 (2*1024*64)
#define BOTS_APP_DEF_ARG_CUTOFF_1 (2*1024*1024)
//#define BOTS_APP_DEF_ARG_CUTOFF_1 (2*1024*1024*2)
...
//#define BOTS_APP_DEF_ARG_CUTOFF_2 (2000)
